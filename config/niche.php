    ...
    'niches' => [
        ...
        'food_service' => [
            'labels' => [
                ...
                'entities' => 'Pedidos',
                'url_slug' => 'pedido',
                'url_entities_slug' => 'pedidos',
                'url_client_slug' => 'cliente',
                'url_clients_slug' => 'clientes',
                'new_entity' => 'Novo Pedido',
                'identifier' => 'Nome/Mesa',
                'secondary_identifier' => 'Senha',
                'metric' => 'Pessoas',
                'metric_unit' => 'pers',
                'fuel' => 'Ponto/Preparo',
                'fuel_levels' => ['Padrão', 'Bem Passado', 'Mal Passado', 'Sem Molho', 'Extra Molho'],
                'visual_inspection_title' => 'Personalização do Lanche',
                'visual_inspection_help' => 'Clique nos ingredientes para adicionar extras ou remover itens.',
                'visual_inspection_prompt_title' => 'Observação do Item',
                'visual_inspection_prompt_placeholder' => 'Ex: Sem milho, Adicionar Bacon...',
                'brand' => 'Categoria',
                'model' => 'Lanche/Prato',
                'color' => 'Acompanhamento',
                'year' => 'Horário Pedido',
                'features' => 'Observações/Alergias',
                'inventory_items' => 'Insumos/Ingredientes',
                'in_service_label' => 'Na Cozinha',
                'timeline_checkin_body' => 'Seu pedido foi recebido e já está na fila de preparo.',
                'timeline_execution_body' => 'O Chef está preparando o seu pedido com todo carinho agora.',
                'timeline_finalizing_body' => 'Pedido finalizado! Já está saindo para entrega ou balcão.',
                'checklist_categories' => [
                    'Proteína' => ['Salsicha', 'Salsicha Dupla', 'Frango Desfiado', 'Carne Moída', 'Bacon'],
                    'Salada/Extras' => ['Milho', 'Ervilha', 'Vinagrete', 'Batata Palha', 'Purê de Batata'],
                    'Molhos' => ['Ketchup', 'Mostarda', 'Maionese Caseira', 'Maionese Verde', 'Picante'],
                    'Bebidas' => ['Coca-Cola 350ml', 'Guaraná 350ml', 'Suco Natural', 'Água Mineral']
                ],
