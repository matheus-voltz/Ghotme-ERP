...
<div data-bs-spy="scroll" class="scrollspy-example">
    ...
    <div id="landingHero" class="section-py landing-hero position-relative">
      ...
      <div class="container">
        <div class="hero-text-box text-center position-relative">
          <h1 class="text-primary hero-title display-6 fw-extrabold">Um painel para gerenciar todos os seus negócios</h1>
          <h2 class="hero-sub-title h6 mb-6">
            Template de administração pronto para produção e fácil de usar<br class="d-none d-lg-block" />
            para confiabilidade e personalização.
          </h2>
          <div class="landing-hero-btn d-inline-block position-relative">
            <span class="hero-btn-item position-absolute d-none d-md-flex fw-medium">Junte-se à comunidade <img
              src="{{ asset('assets/img/front-pages/icons/Join-community-arrow.png') }}" alt="Seta junte-se à comunidade"
              class="scaleX-n1-rtl" /></span>
            <a href="#landingPricing" class="btn btn-primary btn-lg">Garanta acesso antecipado</a>
          </div>
        </div>
  ...
  <section id="landingFeatures" class="section-py landing-features">
    <div class="container">
      ...
      <h4 class="text-center mb-1">
        ...
        para começar seu próximo projeto
      </h4>
      <p class="text-center mb-12">Não é apenas um conjunto de ferramentas, o pacote inclui uma aplicação conceitual pronta para uso.
      </p>
      <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          ...
          <h5 class="mb-2">Código de Qualidade</h5>
          <p class="features-icon-description">Estrutura de código que todos os desenvolvedores vão entender facilmente e se apaixonar.</p>
        </div>
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="mb-4 text-primary text-center">
          ...
          <h5 class="mb-2">Atualizações Contínuas</h5>
          <p class="features-icon-description">Atualizações gratuitas pelos próximos 12 meses, incluindo novos exemplos e funcionalidades.
          </p>
        </div>
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          ...
          <h5 class="mb-2">Kit Inicial</h5>
          <p class="features-icon-description">Comece seu projeto rapidamente sem precisar remover funcionalidades desnecessárias.
          </p>
        </div>
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4 text-primary">
          ...
          <h5 class="mb-2">Pronto para API</h5>
          <p class="features-icon-description">Basta alterar o endpoint e veja seus próprios dados carregados em segundos.</p>
        </div>
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4 text-primary">
            <svg width="64" height="65" viewBox="0 0 64 65" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <h5 class="mb-2">Suporte Excelente</h5>
          <p class="features-icon-description">Documentação fácil de seguir com muitas referências e exemplos de código.</p>
        </div>
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="text-center mb-4 text-primary">
            <svg width="64" height="65" viewBox="0 0 64 65" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <h5 class="mb-2">Bem Documentado</h5>
          <p class="features-icon-description">Documentação fácil de seguir com muitas referências e exemplos de código.</p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row align-items-center gx-0 gy-4 g-lg-5 mb-5 pb-md-5">
        <div class="col-md-6 col-lg-5 col-xl-3">
          ...
          <h4 class="mb-1">
            <span class="position-relative fw-extrabold z-1">O que dizem
              <img src="{{ asset('assets/img/front-pages/icons/section-title-icon.png') }}" alt="notebook carregando"
                class="section-title-img position-absolute object-fit-contain bottom-0 z-n1" />
            </span>
          </h4>
          <p class="mb-5 mb-md-12">
            Veja o que nossos clientes têm a dizer<br class="d-none d-xl-block" />
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                      ...
                      <p>“Vuexy é, sem dúvida, o tema Bootstrap mais útil que já usei. Mal posso esperar para usar novamente no meu próximo projeto.”</p>
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                      ...
                      <p>“Nunca usei um tema tão versátil e flexível quanto o Vuexy. É minha escolha para construir painéis em quase todos os projetos.”</p>
                      <div class="text-warning mb-4">
                        <i class="icon-base ti tabler-star-filled"></i>
                        <i class="icon-base ti tabler-star-filled"></i>
                        <i class="icon-base ti tabler-star-filled"></i>
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                      ...
                      <p>Este template é realmente limpo e bem documentado. A documentação é fácil de entender e sempre encontro exemplos visuais no site.</p>
                      <div class="text-warning mb-4">
                        <i class="icon-base ti tabler-star-filled"></i>
                        <i class="icon-base ti tabler-star-filled"></i>
                        <i class="icon-base ti tabler-star-filled"></i>
                ...
                <div class="swiper-slide">
                  <div class="card h-100">
                    <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                      ...
                      <p>Todos os requisitos para desenvolvedores foram considerados, então consigo construir qualquer interface que quiser.</p>
                      <div class="text-warning mb-4">
                        <i class="icon-base ti tabler-star-filled"></i>
                        <i class="icon-base ti tabler-star-filled"></i>
                        <i class="icon-base ti tabler-star-filled"></i>
  ...
  <section id="landingTeam" class="section-py landing-team">
    <div class="container">
      <div class="text-center mb-4">
        <span class="badge bg-label-primary">Nosso Grande Time</span>
      </div>
      <h4 class="text-center mb-1">
        <span class="position-relative fw-extrabold z-1">Apoiado
          <img src="{{ asset('assets/img/front-pages/icons/section-title-icon.png') }}" alt="notebook carregando"
            class="section-title-img position-absolute object-fit-contain bottom-0 z-n1" />
        </span>
        por pessoas reais
      </h4>
      <p class="text-center mb-md-11 pb-0 pb-xl-12">Quem está por trás dessas interfaces incríveis?</p>
  ...
  <section id="landingPricing" class="section-py bg-body landing-pricing">
    <div class="container">
      ...
      <p class="text-center pb-2 mb-7">Todos os planos incluem mais de 40 ferramentas e recursos avançados para impulsionar seu produto.<br />Escolha o melhor plano para suas necessidades.</p>
      <div class="text-center mb-12">
        <div class="position-relative d-inline-block pt-3 pt-md-0">
          <label class="switch switch-sm switch-primary me-0">
            <span class="switch-label fs-6 text-body me-3">Pagar Mensalmente</span>
            <input type="checkbox" class="switch-input price-duration-toggler" checked />
            <span class="switch-toggle-slider">
              <span class="switch-on"></span>
              <span class="switch-off"></span>
            </span>
            <span class="switch-label fs-6 text-body ms-3">Pagar Anual</span>
          </label>
          <div class="pricing-plans-item position-absolute d-flex">
            <img src="{{ asset('assets/img/front-pages/icons/pricing-plans-arrow.png') }}" alt="pricing plans arrow"
              class="scaleX-n1-rtl" />
            <span class="fw-medium mt-2 ms-1"> Economize 25%</span>
          </div>
        </div>
      </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="d-grid mt-8">
                <a href="{{ url('/front-pages/payment') }}" class="btn btn-label-primary">Começar</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-4 col-lg-6">
          <div class="card border border-primary shadow-xl">
            ...
            <div class="card-body">
              <ul class="list-unstyled pricing-list">
                ...
                <li>
                  <h6 class="d-flex align-items-center mb-3">
                    <span class="badge badge-center rounded-pill bg-primary p-0 me-3"><i
                        class="icon-base ti tabler-check icon-12px"></i></span>
                    Linha do tempo com banco de dados
                  </h6>
                </li>
                <li>
                  <h6 class="d-flex align-items-center mb-3">
              ...
              <div class="d-grid mt-8">
                <a href="{{ url('/front-pages/payment') }}" class="btn btn-primary">Começar</a>
              </div>
            </div>
          </div>
        </div>
  ...
  <section id="landingFAQ" class="section-py bg-body landing-faq">
    <div class="container">
      ...
      <p class="text-center mb-12 pb-md-4">Veja abaixo as respostas para as dúvidas mais comuns.</p>
            ...
            <div class="card accordion-item">
              <h2 class="accordion-header" id="headingOne">
                <button type="button" class="accordion-button" data-bs-toggle="collapse" data-bs-target="#accordionOne"
                  aria-expanded="true" aria-controls="accordionOne">Vocês cobram por cada atualização?</button>
              </h2>

              <div id="accordionOne" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                <div class="accordion-body">Não, todas as atualizações estão inclusas no seu plano durante o período contratado.</div>
              </div>
            </div>
            <div class="card accordion-item">
              <h2 class="accordion-header" id="headingTwo">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                  data-bs-target="#accordionTwo" aria-expanded="false" aria-controls="accordionTwo">Preciso comprar uma licença para cada site?</button>
              </h2>
              <div id="accordionTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo"
                data-bs-parent="#accordionExample">
                <div class="accordion-body">Sim, cada site/domínio requer uma licença separada.</div>
              </div>
            </div>
            <div class="card accordion-item active">
              <h2 class="accordion-header" id="headingThree">
                <button type="button" class="accordion-button" data-bs-toggle="collapse"
                  data-bs-target="#accordionThree" aria-expanded="false" aria-controls="accordionThree">O que é a licença regular?</button>
              </h2>
              <div id="accordionThree" class="accordion-collapse collapse show" aria-labelledby="headingThree"
                data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  A licença regular pode ser usada para produtos finais que não cobram dos usuários pelo acesso ou serviço (acesso gratuito, sem mensalidade). Uma licença regular pode ser usada para um único produto final, seja por você ou seu cliente. Se quiser vender o produto final para vários clientes, será necessário adquirir uma licença para cada um. O mesmo vale para uso em múltiplos domínios (instalações únicas). Para mais informações, consulte a descrição oficial.
                </div>
              </div>
            </div>
            <div class="card accordion-item">
              <h2 class="accordion-header" id="headingFour">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                  data-bs-target="#accordionFour" aria-expanded="false" aria-controls="accordionFour">O que é a licença estendida?</button>
              </h2>
              <div id="accordionFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                data-bs-parent="#accordionExample">
                <div class="accordion-body">A licença estendida permite que você cobre dos usuários pelo acesso ou serviço do produto final. Consulte a documentação para detalhes.</div>
              </div>
            </div>
            <div class="card accordion-item">
              <h2 class="accordion-header" id="headingFive">
                <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                  data-bs-target="#accordionFive" aria-expanded="false" aria-controls="accordionFive">Qual licença é aplicável para aplicações SaaS?</button>
              </h2>
              <div id="accordionFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                data-bs-parent="#accordionExample">
                <div class="accordion-body">Para aplicações SaaS, é necessário adquirir a licença estendida.</div>
              </div>
            </div>
          </div>
        </div>
  ...
  <section id="landingContact" class="section-py bg-body landing-contact">
    <div class="container">
      ...
      <p class="text-center mb-12 pb-md-4">Alguma dúvida ou sugestão? Escreva para nós!</p>
      <div class="row g-6">
        <div class="col-lg-5">
        ...
        <div class="col-lg-7">
          <div class="card h-100">
            <div class="card-body">
              ...
              <p class="mb-6">
                Se você deseja discutir algo relacionado a pagamento, conta, licenciamento,<br
                  class="d-none d-lg-block" />
                parcerias ou tem dúvidas antes da compra, você está no lugar certo.
              </p>
              <form>
                <div class="row g-4">
                  <div class="col-md-6">
