...
const translations = {
    'pt-BR': {
        ...
        due_soon: 'Vence Logo',
        search_bill: 'Buscar conta ou fornecedor...',
        add_bill: 'Nova Conta',
        status_paid: 'Pago',
        status_unpaid: 'Pendente',
        status_overdue: 'Atrasado',
        category_bills: 'Contas',
    ...
    'en': {
        ...
        due_soon: 'Due Soon',
        search_bill: 'Search bill or supplier...',
        add_bill: 'New Bill',
        status_paid: 'Paid',
