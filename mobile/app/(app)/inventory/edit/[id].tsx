...
export default function EditInventoryScreen() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            setForm({
                ...
                menu_category_id: item.menu_category_id ? item.menu_category_id.toString() : ''
            });
            ...
            setControlStock(item.min_quantity > 0 || item.quantity > 0);
    ...
    const handleSubmit = async () => {
        ...
        const payload = {
            ...
            image_base64: image?.startsWith('data:image') ? image : null // Only send if it's new base64
        };
        ...
        try {
            ...
            Haptics.notificationAsync(Haptics.NotificationFeedbackType.Success);
            Alert.alert("Sucesso", `${itemLabel} atualizado!`, [
    ...
    return (
        <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{ flex: 1, backgroundColor: colors.background }}>
            <View style={[styles.header, { backgroundColor: colors.background }]}>
                ...
                <Text style={[styles.headerTitle, { color: colors.text }]}>Editar {itemLabel}</Text>
                <View style={{ width: 40 }} />
            </View>
